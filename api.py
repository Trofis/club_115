...
def get_next_leagues_round():
    ...
    for league in leagues.items():
        ...
        coming_play_off_country = []
        for play_off in coming_play_off:
            coming_play_off_country.append(
                {
                    "fixture_id": play_off['fixture_id'],
                    "event_date": play_off['event_date'],
                    "round": play_off['round'],
                    "team_id_home": play_off['homeTeam']['team_id'],
                    "team_name_home": play_off['homeTeam']['team_name'],
                    "logo_home": play_off['homeTeam']['logo'],
                    "team_id_away": play_off['awayTeam']['team_id'],
                    "team_name_away": play_off['awayTeam']['team_name'],
                    "logo_away": play_off['awayTeam']['logo'],
                }

            )
        coming_play_off_per_country[league[0]] = coming_play_off_country
